...
typedef enum {
	...
	I_CAL_CALENDARADDRESS_PROPERTY = ICAL_CALENDARADDRESS_PROPERTY,
	...
	I_CAL_CONFERENCE_PROPERTY = ICAL_CONFERENCE_PROPERTY,
	...
	I_CAL_IMAGE_PROPERTY = ICAL_IMAGE_PROPERTY,
	...
	I_CAL_LOCATIONTYPE_PROPERTY = ICAL_LOCATIONTYPE_PROPERTY,
	...
	I_CAL_PARTICIPANTTYPE_PROPERTY = ICAL_PARTICIPANTTYPE_PROPERTY,
	I_CAL_PATCHDELETE_PROPERTY = ICAL_PATCHDELETE_PROPERTY,
	I_CAL_PATCHORDER_PROPERTY = ICAL_PATCHORDER_PROPERTY,
	I_CAL_PATCHPARAMETER_PROPERTY = ICAL_PATCHPARAMETER_PROPERTY,
	I_CAL_PATCHTARGET_PROPERTY = ICAL_PATCHTARGET_PROPERTY,
	I_CAL_PATCHVERSION_PROPERTY = ICAL_PATCHVERSION_PROPERTY,
	...
	I_CAL_PROXIMITY_PROPERTY = ICAL_PROXIMITY_PROPERTY,
	...
	I_CAL_REFRESHINTERVAL_PROPERTY = ICAL_REFRESHINTERVAL_PROPERTY,
	...
	I_CAL_RESOURCETYPE_PROPERTY = ICAL_RESOURCETYPE_PROPERTY,
	...
	I_CAL_SOURCE_PROPERTY = ICAL_SOURCE_PROPERTY,
	I_CAL_STATUS_PROPERTY = ICAL_STATUS_PROPERTY,
	I_CAL_STORESEXPANDED_PROPERTY = ICAL_STORESEXPANDED_PROPERTY,
	I_CAL_STRUCTUREDDATA_PROPERTY = ICAL_STRUCTUREDDATA_PROPERTY,
	I_CAL_STYLEDDESCRIPTION_PROPERTY = ICAL_STYLEDDESCRIPTION_PROPERTY,
...
LIBICAL_ICAL_EXPORT
ICalProperty *	i_cal_property_new_calendaraddress
						(const gchar *v);

LIBICAL_ICAL_EXPORT
const gchar *	i_cal_property_get_calendaraddress
						(const ICalProperty *prop);

LIBICAL_ICAL_EXPORT
void		i_cal_property_set_calendaraddress
						(ICalProperty *prop,
						 const gchar *v);
...
LIBICAL_ICAL_EXPORT
ICalProperty *	i_cal_property_new_conference	(const gchar *v);

LIBICAL_ICAL_EXPORT
const gchar *	i_cal_property_get_conference	(const ICalProperty *prop);

LIBICAL_ICAL_EXPORT
void		i_cal_property_set_conference	(ICalProperty *prop,
						 const gchar *v);
...
LIBICAL_ICAL_EXPORT
ICalProperty *	i_cal_property_new_image	(ICalAttach *v);

LIBICAL_ICAL_EXPORT
ICalAttach *	i_cal_property_get_image	(const ICalProperty *prop);

LIBICAL_ICAL_EXPORT
void		i_cal_property_set_image	(ICalProperty *prop,
						 ICalAttach *v);
...
LIBICAL_ICAL_EXPORT
ICalProperty *	i_cal_property_new_locationtype	(const gchar *v);

LIBICAL_ICAL_EXPORT
const gchar *	i_cal_property_get_locationtype	(const ICalProperty *prop);

LIBICAL_ICAL_EXPORT
void		i_cal_property_set_locationtype	(ICalProperty *prop,
						 const gchar *v);
...
LIBICAL_ICAL_EXPORT
ICalProperty *	i_cal_property_new_participanttype
...
LIBICAL_ICAL_EXPORT
void		i_cal_property_set_participanttype
						(ICalProperty *prop,
						 ICalPropertyParticipanttype v);

LIBICAL_ICAL_EXPORT
ICalProperty *	i_cal_property_new_patchdelete	(const gchar *v);

LIBICAL_ICAL_EXPORT
const gchar *	i_cal_property_get_patchdelete	(const ICalProperty *prop);

LIBICAL_ICAL_EXPORT
void		i_cal_property_set_patchdelete	(ICalProperty *prop,
						 const gchar *v);

LIBICAL_ICAL_EXPORT
ICalProperty *	i_cal_property_new_patchorder	(gint v);

LIBICAL_ICAL_EXPORT
gint 		i_cal_property_get_patchorder	(const ICalProperty *prop);

LIBICAL_ICAL_EXPORT
void		i_cal_property_set_patchorder	(ICalProperty *prop,
						 gint v);

LIBICAL_ICAL_EXPORT
ICalProperty *	i_cal_property_new_patchparameter
						(const gchar *v);

LIBICAL_ICAL_EXPORT
const gchar *	i_cal_property_get_patchparameter
						(const ICalProperty *prop);

LIBICAL_ICAL_EXPORT
void		i_cal_property_set_patchparameter
						(ICalProperty *prop,
						 const gchar *v);

LIBICAL_ICAL_EXPORT
ICalProperty *	i_cal_property_new_patchtarget	(const gchar *v);

LIBICAL_ICAL_EXPORT
const gchar *	i_cal_property_get_patchtarget	(const ICalProperty *prop);

LIBICAL_ICAL_EXPORT
void		i_cal_property_set_patchtarget	(ICalProperty *prop,
						 const gchar *v);

LIBICAL_ICAL_EXPORT
ICalProperty *	i_cal_property_new_patchversion	(const gchar *v);

LIBICAL_ICAL_EXPORT
const gchar *	i_cal_property_get_patchversion	(const ICalProperty *prop);

LIBICAL_ICAL_EXPORT
void		i_cal_property_set_patchversion	(ICalProperty *prop,
						 const gchar *v);
...
LIBICAL_ICAL_EXPORT
ICalProperty *	i_cal_property_new_proximity	(ICalPropertyProximity v);

LIBICAL_ICAL_EXPORT
ICalPropertyProximity 
		i_cal_property_get_proximity	(const ICalProperty *prop);

LIBICAL_ICAL_EXPORT
void		i_cal_property_set_proximity	(ICalProperty *prop,
...
LIBICAL_ICAL_EXPORT
ICalProperty *	i_cal_property_new_refreshinterval
						(ICalDuration *v);

LIBICAL_ICAL_EXPORT
ICalDuration *	i_cal_property_get_refreshinterval
						(const ICalProperty *prop);

LIBICAL_ICAL_EXPORT
void		i_cal_property_set_refreshinterval
						(ICalProperty *prop,
						 ICalDuration *v);
...
LIBICAL_ICAL_EXPORT
ICalProperty *	i_cal_property_new_resourcetype	(ICalPropertyResourcetype v);

LIBICAL_ICAL_EXPORT
ICalPropertyResourcetype 
		i_cal_property_get_resourcetype	(const ICalProperty *prop);

LIBICAL_ICAL_EXPORT
void		i_cal_property_set_resourcetype	(ICalProperty *prop,
...
LIBICAL_ICAL_EXPORT
ICalProperty *	i_cal_property_new_source	(const gchar *v);

LIBICAL_ICAL_EXPORT
const gchar *	i_cal_property_get_source	(const ICalProperty *prop);

LIBICAL_ICAL_EXPORT
void		i_cal_property_set_source	(ICalProperty *prop,
						 const gchar *v);
...
LIBICAL_ICAL_EXPORT
ICalProperty *	i_cal_property_new_structureddata
						(ICalAttach *v);

LIBICAL_ICAL_EXPORT
ICalAttach *	i_cal_property_get_structureddata
						(const ICalProperty *prop);

LIBICAL_ICAL_EXPORT
void		i_cal_property_set_structureddata
						(ICalProperty *prop,
						 ICalAttach *v);

LIBICAL_ICAL_EXPORT
ICalProperty *	i_cal_property_new_styleddescription
						(const gchar *v);

LIBICAL_ICAL_EXPORT
const gchar *	i_cal_property_get_styleddescription
						(const ICalProperty *prop);

LIBICAL_ICAL_EXPORT
void		i_cal_property_set_styleddescription
						(ICalProperty *prop,
						 const gchar *v);

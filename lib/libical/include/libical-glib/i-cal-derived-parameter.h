...
typedef enum {
	...
	I_CAL_DERIVED_PARAMETER = ICAL_DERIVED_PARAMETER,
	...
	I_CAL_ORDER_PARAMETER = ICAL_ORDER_PARAMETER,
	...
	I_CAL_SCHEMA_PARAMETER = ICAL_SCHEMA_PARAMETER,
...
typedef enum {
	I_CAL_DERIVED_X = ICAL_DERIVED_X,
	I_CAL_DERIVED_TRUE = ICAL_DERIVED_TRUE,
	I_CAL_DERIVED_FALSE = ICAL_DERIVED_FALSE,
	I_CAL_DERIVED_NONE = ICAL_DERIVED_NONE
...
typedef enum {
	...
	I_CAL_RELTYPE_SNOOZE = ICAL_RELTYPE_SNOOZE,
...
LIBICAL_ICAL_EXPORT
ICalParameter *	i_cal_parameter_new_derived	(ICalParameterDerived v);

LIBICAL_ICAL_EXPORT
ICalParameterDerived 
		i_cal_parameter_get_derived	(const ICalParameter *param);

LIBICAL_ICAL_EXPORT
void		i_cal_parameter_set_derived	(ICalParameter *param,
...
LIBICAL_ICAL_EXPORT
ICalParameter *	i_cal_parameter_new_order	(gint v);

LIBICAL_ICAL_EXPORT
gint 		i_cal_parameter_get_order	(const ICalParameter *param);

LIBICAL_ICAL_EXPORT
void		i_cal_parameter_set_order	(ICalParameter *param,
						 gint v);
...
LIBICAL_ICAL_EXPORT
ICalParameter *	i_cal_parameter_new_schema	(const gchar *v);

LIBICAL_ICAL_EXPORT
const gchar *	i_cal_parameter_get_schema	(const ICalParameter *param);

LIBICAL_ICAL_EXPORT
void		i_cal_parameter_set_schema	(ICalParameter *param,
						 const gchar *v);

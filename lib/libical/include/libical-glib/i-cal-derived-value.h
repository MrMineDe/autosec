...
typedef enum {
	...
	I_CAL_PARTICIPANTTYPE_VALUE = ICAL_PARTICIPANTTYPE_VALUE,
	...
	I_CAL_PROXIMITY_VALUE = ICAL_PROXIMITY_VALUE,
	I_CAL_RESOURCETYPE_VALUE = ICAL_RESOURCETYPE_VALUE,
...
typedef enum {
	...
	I_CAL_METHOD_POLLSTATUS = ICAL_METHOD_POLLSTATUS,
	I_CAL_METHOD_NONE = ICAL_METHOD_NONE
} ICalPropertyMethod;

typedef enum {
	I_CAL_PARTICIPANTTYPE_X = ICAL_PARTICIPANTTYPE_X,
	I_CAL_PARTICIPANTTYPE_ACTIVE = ICAL_PARTICIPANTTYPE_ACTIVE,
	I_CAL_PARTICIPANTTYPE_INACTIVE = ICAL_PARTICIPANTTYPE_INACTIVE,
	I_CAL_PARTICIPANTTYPE_SPONSOR = ICAL_PARTICIPANTTYPE_SPONSOR,
	I_CAL_PARTICIPANTTYPE_CONTACT = ICAL_PARTICIPANTTYPE_CONTACT,
	I_CAL_PARTICIPANTTYPE_BOOKINGCONTACT = ICAL_PARTICIPANTTYPE_BOOKINGCONTACT,
	I_CAL_PARTICIPANTTYPE_EMERGENCYCONTACT = ICAL_PARTICIPANTTYPE_EMERGENCYCONTACT,
	I_CAL_PARTICIPANTTYPE_PUBLICITYCONTACT = ICAL_PARTICIPANTTYPE_PUBLICITYCONTACT,
	I_CAL_PARTICIPANTTYPE_PLANNERCONTACT = ICAL_PARTICIPANTTYPE_PLANNERCONTACT,
	I_CAL_PARTICIPANTTYPE_PERFORMER = ICAL_PARTICIPANTTYPE_PERFORMER,
	I_CAL_PARTICIPANTTYPE_SPEAKER = ICAL_PARTICIPANTTYPE_SPEAKER,
	I_CAL_PARTICIPANTTYPE_NONE = ICAL_PARTICIPANTTYPE_NONE
...
typedef enum {
	I_CAL_PROXIMITY_X = ICAL_PROXIMITY_X,
	I_CAL_PROXIMITY_ARRIVE = ICAL_PROXIMITY_ARRIVE,
	I_CAL_PROXIMITY_DEPART = ICAL_PROXIMITY_DEPART,
	I_CAL_PROXIMITY_CONNECT = ICAL_PROXIMITY_CONNECT,
	I_CAL_PROXIMITY_DISCONNECT = ICAL_PROXIMITY_DISCONNECT,
	I_CAL_PROXIMITY_NONE = ICAL_PROXIMITY_NONE
...
typedef enum {
	I_CAL_RESOURCETYPE_X = ICAL_RESOURCETYPE_X,
	I_CAL_RESOURCETYPE_ROOM = ICAL_RESOURCETYPE_ROOM,
	I_CAL_RESOURCETYPE_PROJECTOR = ICAL_RESOURCETYPE_PROJECTOR,
	I_CAL_RESOURCETYPE_REMOTECONFERENCEAUDIO = ICAL_RESOURCETYPE_REMOTECONFERENCEAUDIO,
	I_CAL_RESOURCETYPE_REMOTECONFERENCEVIDEO = ICAL_RESOURCETYPE_REMOTECONFERENCEVIDEO,
	I_CAL_RESOURCETYPE_NONE = ICAL_RESOURCETYPE_NONE
...
LIBICAL_ICAL_EXPORT
ICalValue *	i_cal_value_new_participanttype	(ICalPropertyParticipanttype v);

LIBICAL_ICAL_EXPORT
ICalPropertyParticipanttype 
		i_cal_value_get_participanttype	(const ICalValue *val);

LIBICAL_ICAL_EXPORT
void		i_cal_value_set_participanttype	(ICalValue *val,
						 ICalPropertyParticipanttype v);

LIBICAL_ICAL_EXPORT
ICalValue *	i_cal_value_new_proximity	(ICalPropertyProximity v);

LIBICAL_ICAL_EXPORT
ICalPropertyProximity 
		i_cal_value_get_proximity	(const ICalValue *val);

LIBICAL_ICAL_EXPORT
void		i_cal_value_set_proximity	(ICalValue *val,
						 ICalPropertyProximity v);

LIBICAL_ICAL_EXPORT
ICalValue *	i_cal_value_new_resourcetype	(ICalPropertyResourcetype v);

LIBICAL_ICAL_EXPORT
ICalPropertyResourcetype 
		i_cal_value_get_resourcetype	(const ICalValue *val);

LIBICAL_ICAL_EXPORT
void		i_cal_value_set_resourcetype	(ICalValue *val,
